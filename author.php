...
$strutturememb = get_posts($args); /*$strutture = get_posts($args);*/
function filter_my_structures_memb($structure)/*function filter_my_structures($structure)*/
{
...
$strutture = array_merge($struttureresp, $strutturememb);/*$strutture = array_filter($strutture, "filter_my_structures");*/
