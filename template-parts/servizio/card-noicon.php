    ...
    <div class="card card-bg card-noicon rounded" style="max-height: 100%;"> <!-- vecchio <div class="card card-bg card-noicon rounded"> -->
        <a href="<?php echo get_permalink($servizio); ?>">
            <div class="card-body">
                ...
                <div class="card-thumb"><!-- aggiunta immagine -->
                	<img style="width: 100%; padding-top: 5px; height: 150px; object-fit: cover;" src="<?php echo $image_url; ?>" alt="">
		</div><!-- /aggiunta immagine -->
            </div><!-- /card-body -->
        </a>
